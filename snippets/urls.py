...
from .views import HomePage,CreateSnippet,DetailSnippet,DeleteSnippet,ListSnippet,MyStyleFile,TopContributers,TopLanguages,GetLangDetails,AddBookMark,DeleteBookMark
